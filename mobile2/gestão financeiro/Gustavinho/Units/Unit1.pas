...
uses
  ...
  System.Actions, FMX.ActnList, u99Permissions, FMX.MediaLibrary,
...
type
  TFrmLogin = class(TForm)
    ...
    procedure ActCameraDidFinishTaking(Image: TBitmap); // ADICIONADO NA INTERFACE
  private
...
begin
   TabControl1.ActiveTab := TabILogin;
end;
...
// ADICIONADO NA IMPLEMENTAÇÃO: Faz voltar para a aba de foto ao clicar
